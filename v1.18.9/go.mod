module github.com/appscodelabs/k8s-gomod-refresher/v1.18.9

go 1.14

require (
	go.bytebuilders.dev/license-verifier v0.6.0
	go.bytebuilders.dev/license-verifier/kubernetes v0.6.0
	k8s.io/api v0.18.9
